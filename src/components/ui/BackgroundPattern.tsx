...
export default function BackgroundPattern() {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-white via-[#FFD935]/15 to-[#FFD935]/25"></div>
      ...
      <div className="absolute inset-0">
        {/* Band 1 */}
        <motion.div
          className="absolute top-0 left-0 w-full h-32 bg-gradient-to-r from-[#FFD935]/40 to-[#FFD935]/50"
          style={{
        ...
        {/* Band 2 */}
        <motion.div
          className="absolute top-20 left-0 w-full h-40 bg-gradient-to-r from-[#FFD935]/30 to-[#FFD935]/40"
          style={{
        ...
        {/* Band 3 */}
        <motion.div
          className="absolute top-40 left-0 w-full h-36 bg-gradient-to-r from-[#FFD935]/35 to-[#FFD935]/45"
          style={{
        ...
        {/* Band 4 */}
        <motion.div
          className="absolute top-60 left-0 w-full h-44 bg-gradient-to-r from-[#FFD935]/30 to-[#FFD935]/40"
          style={{
        ...
        {/* Band 5 */}
        <motion.div
          className="absolute top-80 left-0 w-full h-32 bg-gradient-to-r from-[#FFD935]/40 to-[#FFD935]/50"
          style={{
