...
const applySecurityHeaders = (response: NextResponse) => {
  ...
  const csp = [
    ...
    "connect-src 'self' https://api.stripe.com https://api.mailgun.net https://api.mpesa.vm.co.ke https://www.google.com https://www.gstatic.com https://www.recaptcha.net https://vercel.live https:",
    "frame-src 'self' https://js.stripe.com https://hooks.stripe.com https://www.google.com https://www.gstatic.com https://www.recaptcha.net https:",
    "object-src 'none'",
    "base-uri 'self'",
    "form-action 'self'",
